function newQuestion(){
	...
	props.push('<div class="form-row"><label for="points'+x+'" class="col col-lg-6 col-md-6 col-xs-8 col-form-label"> Points pour cette question(pas de chiffre à virgule)</label>');
...
function checkPropositions(){
	...
	var themesChoisis = document.getElementById('listeThemes').value;
